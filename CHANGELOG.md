...
* Fixed bugs:
  ...
  * Fixed an issue where it was impossible to find a catalog event using the CountdownClass Ticker grid filter if the event had been specified to be displayed on both category and product pages
