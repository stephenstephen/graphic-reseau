 ...
 */
namespace Lyranetwork\Sogecommerce\Setup;
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '2.4.0', '<')) {
            ...
            $customerSetup->addAttribute(
                Customer::ENTITY,
                'sogecommerce_masked_pan',
                [
                    'type' => 'varchar',
                    'input' => 'text',
                    'label' => 'Sogecommerce masked PAN',
            ...
            $select = $connection->select()
                ...
                ->where('status = ?', 'sogecommerce_pending_transfer');
            ...
            if ($count === 0) {
                $connection->insert(
                    ...
                    [
                        'status' => 'sogecommerce_pending_transfer',
        ...
        if (version_compare($context->getVersion(), '2.4.1', '<')) {
            ...
            $customerSetup->addAttribute(
                Customer::ENTITY,
                'sogecommerce_sepa_identifier',
                [
                    'type' => 'varchar',
                    'input' => 'text',
                    'label' => 'Sogecommerce SEPA identifier',
            ...
            $customerSetup->addAttribute(
                Customer::ENTITY,
                'sogecommerce_sepa_iban_bic',
                [
                    'type' => 'varchar',
                    'input' => 'text',
                    'label' => 'Sogecommerce SEPA IBAN/BIC',
