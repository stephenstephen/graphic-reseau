 ...
 */
namespace Lyranetwork\Sogecommerce\Model\AdminOrder;
...
class EmailSender extends \Magento\Sales\Model\AdminOrder\EmailSender
{
    ...
    public function send(\Magento\Sales\Model\Order $order)
    {
        ...
        if ($method instanceof \Lyranetwork\Sogecommerce\Model\Method\Sogecommerce && ! $order->getCanSendNewEmailFlag()) {
            return true;
        }
