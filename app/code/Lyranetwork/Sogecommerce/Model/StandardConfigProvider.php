...
class StandardConfigProvider extends \Lyranetwork\Sogecommerce\Model\SogecommerceConfigProvider
{
    /**
     * @var string|boolean
     */
    ...
    public function __construct(
        ...
        parent::__construct(
            ...
            $urlBuilder,
            $dataHelper,
            \Lyranetwork\Sogecommerce\Helper\Data::METHOD_STANDARD
        );
    }
    ...
    public function getConfig()
    {
        ...
        $maskedPan = '';
        if ($customer && $customer->getCustomAttribute('sogecommerce_masked_pan')) {
            $maskedPan = $customer->getCustomAttribute('sogecommerce_masked_pan')->getValue();
        }
    ...
    private function getIframeLoaderUrl()
    {
        ...
        return $this->urlBuilder->getUrl('sogecommerce/payment_iframe/loader', $params);
    }
