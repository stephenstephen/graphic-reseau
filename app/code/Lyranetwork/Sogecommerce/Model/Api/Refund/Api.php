...
namespace Lyranetwork\Sogecommerce\Model\Api\Refund;
...
class Api {
     ...
     *
     * @param \Lyranetwork\Sogecommerce\Model\Api\Refund\Processor $refundProcessor
    ...
    private function checkRestResult($response, $expectedStatuses = array())
    {
        ...
        if ($response['status'] !== 'SUCCESS') {
            ...
            throw new \Lyranetwork\Sogecommerce\Model\Api\Refund\WsException($errorMessage, $answer['errorCode']);
