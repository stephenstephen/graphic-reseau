...
namespace Lyranetwork\Sogecommerce\Model\Api\Form;
...
class Request
{
     ...
     *
     * @var array[string][Lyranetwork\Sogecommerce\Model\Api\Form\Field]
     * @access private
     */
     ...
     *
     * @param array[string][Lyranetwork\Sogecommerce\Model\Api\Form\Field] $fields already filtered fields list
     * @param bool $hashed
     * @return string
     */
     ...
     *
     * @return array[string][Lyranetwork\Sogecommerce\Model\Api\Form\Field] a list of fields
     */
