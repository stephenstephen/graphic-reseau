...
class Api
{
     ...
     *
     * @return array[int][Lyranetwork\Sogecommerce\Model\Api\Form\Currency]
     */
     ...
     *
     * @param string $alpha3
     * @return \Lyranetwork\Sogecommerce\Model\Api\Form\Currency|null
     */
    public static function findCurrencyByAlphaCode($alpha3)
    {
        ...
        foreach ($list as $currency) {
            /**
             * @var \Lyranetwork\Sogecommerce\Model\Api\Form\Currency $currency
             */
