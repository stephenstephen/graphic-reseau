...
class Fullcb extends Sogecommerce
{
    ...
    protected $_code = \Lyranetwork\Sogecommerce\Helper\Data::METHOD_FULLCB;
    protected $_formBlockType = \Lyranetwork\Sogecommerce\Block\Payment\Form\Fullcb::class;
    ...
    protected function setExtraFields($order)
    {
        ...
        if ($info->getCcType()) {
            ...
            $this->sogecommerceRequest->set('payment_cards', 'FULLCB3X;FULLCB4X');
        }
    }
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $option = $sogecommerceData->getData('sogecommerce_fullcb_option');
        if ($option) {
            $info->setCcType($option)->setAdditionalInformation(\Lyranetwork\Sogecommerce\Helper\Payment::FULLCB_OPTION, $option);
        }
