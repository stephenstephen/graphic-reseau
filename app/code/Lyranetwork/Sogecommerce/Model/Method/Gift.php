...
{
    protected $_code = \Lyranetwork\Sogecommerce\Helper\Data::METHOD_GIFT;
    protected $_formBlockType = \Lyranetwork\Sogecommerce\Block\Payment\Form\Gift::class;
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $info->setCcType($sogecommerceData->getData('sogecommerce_gift_cc_type'));
