...
Use  Lyranetwork\Sogecommerce\Helper\Checkout;

class Oney extends Sogecommerce
{
    protected $_code = \Lyranetwork\Sogecommerce\Helper\Data::METHOD_ONEY;
    protected $_formBlockType = \Lyranetwork\Sogecommerce\Block\Payment\Form\Oney::class;
    ...
    /**
     * @var \Lyranetwork\Sogecommerce\Model\System\Config\Source\OneyAvailableCountry
     */
    ...
    public function __construct(
        ...
        \Lyranetwork\Sogecommerce\Model\System\Config\Source\OneyAvailableCountry $oneyCountries,
    ...
    protected function setExtraFields($order)
    {
        ...
        $option = @unserialize($info->getAdditionalInformation(\Lyranetwork\Sogecommerce\Helper\Payment::ONEY_OPTION));

        // Override with Oney option payment mean.
        $this->sogecommerceRequest->set('payment_cards', $option['card_type']);
        $this->sogecommerceRequest->set('payment_option_code', $option['code']);
    }
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $option = $this->getOption($sogecommerceData->getData('sogecommerce_oney_option'));
        $info->setAdditionalInformation(\Lyranetwork\Sogecommerce\Helper\Payment::ONEY_OPTION, serialize($option));
    ...
    public function isAvailable(\Magento\Quote\Api\Data\CartInterface $quote = null)
    {
        ...
        if (! $quote->isVirtual() && $quote->getShippingAddress()->getShippingMethod()) {
            $shippingMethod = $this->checkoutHelper->toSogecommerceCarrier($quote->getShippingAddress()->getShippingMethod());
            if (! $shippingMethod) {
