...
use Lyranetwork\Sogecommerce\Model\System\Config\Source\ChoozeoCountry;

class Choozeo extends Sogecommerce
{
    protected $_code = \Lyranetwork\Sogecommerce\Helper\Data::METHOD_CHOOZEO;
    protected $_formBlockType = \Lyranetwork\Sogecommerce\Block\Payment\Form\Choozeo::class;
    ...
    protected function setExtraFields($order)
    {
        ...
        $this->sogecommerceRequest->set('cust_status', 'PRIVATE');
        $this->sogecommerceRequest->set('cust_country', 'FR');
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $option = $sogecommerceData->getData('sogecommerce_choozeo_option');
        $info->setCcType($option)->setAdditionalInformation(\Lyranetwork\Sogecommerce\Helper\Payment::CHOOZEO_OPTION, $option);
