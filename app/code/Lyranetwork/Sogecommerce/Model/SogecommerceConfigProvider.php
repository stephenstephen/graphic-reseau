...
class SogecommerceConfigProvider implements \Magento\Checkout\Model\ConfigProviderInterface
{
    /**
    ...
    protected function getCheckoutRedirectUrl()
    {
        ...
        return $this->urlBuilder->getUrl('sogecommerce/payment/redirect', $params);
    }
