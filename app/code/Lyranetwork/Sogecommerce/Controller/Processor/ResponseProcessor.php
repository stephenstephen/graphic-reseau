...
class ResponseProcessor
{
    ...
    public function execute(
        ...
        if ($order->getStatus() === 'pending_payment') {
            ...
            $successStatuses = [
                ...
                'sogecommerce_to_validate', // Payment will be OK after manual validation.
                'sogecommerce_pending_transfer' // For SEPA payments.
            ];
    ...
    public function prepareResponse($params)
    {
        ...
        if (! $response->isAuthentified()) {
            ...
            $msg = "{$this->dataHelper->getIpAddress()} tries to access sogecommerce/payment/response page without valid signature with parameters: " . json_encode($params);
            $msg .= "\n";
            $msg .= 'Signature algorithm selected in module settings must be the same as one selected in Sogecommerce Back Office.';
