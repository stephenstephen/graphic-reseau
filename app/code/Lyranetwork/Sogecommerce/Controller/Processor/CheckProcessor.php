...
use \Lyranetwork\Sogecommerce\Helper\Payment;
...
class CheckProcessor
{
    ...
    /**
     * @var \Lyranetwork\Sogecommerce\Model\Api\Form\ResponseFactory
     */
    protected $sogecommerceResponseFactory;
    ...
    public function execute(
        ...
        $reviewStatuses = [
            'payment_review',
            'sogecommerce_to_validate',
            'fraud',
            'sogecommerce_pending_transfer'
        ];
    ...
    public function prepareResponse($params)
    {
        ...
        if (! $response->isAuthentified()) {
            ...
            $this->dataHelper->log(
                "{$this->dataHelper->getIpAddress()} tries to access sogecommerce/payment/check page without valid signature with parameters: " . json_encode($params),
                \Psr\Log\LogLevel::ERROR
            );

            $this->dataHelper->log(
                'Signature algorithm selected in module settings must be the same as one selected in Sogecommerce Back Office.',
                \Psr\Log\LogLevel::ERROR
            );
    ...
    public function getSogecommerceResponseFactory()
    {
        return $this->sogecommerceResponseFactory;
    }
}
