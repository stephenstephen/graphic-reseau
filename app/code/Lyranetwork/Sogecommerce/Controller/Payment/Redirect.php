...
use Lyranetwork\Sogecommerce\Model\OrderException;
...
class Redirect extends \Magento\Framework\App\Action\Action
{
    ...
    /**
     * @var \Lyranetwork\Sogecommerce\Controller\Processor\RedirectProcessor
     */
     ...
     * @param \Lyranetwork\Sogecommerce\Controller\Processor\RedirectProcessor $redirectProcessor
     * @param \Magento\Framework\View\Result\PageFactory $resultPageFactory
     */
    public function __construct(
        \Magento\Framework\App\Action\Context $context,
        \Magento\Sales\Model\OrderFactory $orderFactory,
        \Lyranetwork\Sogecommerce\Controller\Processor\RedirectProcessor $redirectProcessor,
    ...
    public function execute()
    {
        try {
            ...
            return $this->forward();
        } catch (\Lyranetwork\Sogecommerce\Model\OrderException $e) {
    ...
    private function forward()
    {
        ...
        if ($this->getRequest()->getParam('iframe', false)) {
            $resultPage->addHandle('sogecommerce_payment_iframe_redirect');
        } else {
            $resultPage->addHandle('sogecommerce_payment_form_redirect');
