 ...
 */
namespace Lyranetwork\Sogecommerce\Controller\Adminhtml\System\Config;
...
class Reset extends \Magento\Backend\App\AbstractAction
{
    ...
    public function execute()
    {
        ...
        $where = [];
        $where[] = $connection->quoteInto('path REGEXP ?', '^payment/sogecommerce_[a-z0-9]+/[a-z0-9_]+$');
        $where[] = $connection->quoteInto('path REGEXP ?', '^sogecommerce/general/[a-z0-9_]+$');
        ...
        $this->messageManager->addSuccessMessage(
            __('The configuration of the Sogecommerce module has been successfully reset.')
        );
