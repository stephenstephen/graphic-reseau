 ...
 */
namespace Lyranetwork\Sogecommerce\Block\Adminhtml\System\Config\Form\Field\Other;

/**
 * Custom renderer for the other payment options field.
 */
class OtherPaymentMeans extends \Lyranetwork\Sogecommerce\Block\Adminhtml\System\Config\Form\Field\FieldArray\ConfigFieldArray
{
    /**
    ...
    /**
     * @var \Lyranetwork\Sogecommerce\Model\System\Config\Source\ValidationMode
     */
    protected $_validationModes;

    /**
     * @var \Lyranetwork\Sogecommerce\Model\Method\Other
     */
    protected $method;
     ...
     * @param \Lyranetwork\Sogecommerce\Model\System\Config\Source\ValidationMode $validationModes
     * @param array $data
     */
    public function __construct(
        ...
        \Lyranetwork\Sogecommerce\Model\System\Config\Source\ValidationMode $validationModes,
        \Lyranetwork\Sogecommerce\Model\Method\Other $method,
        array $data = []
    ) {
        ...
        $script .= "\n" . '
            <script>
                require([
                    ...
                    const selectCardModeInfo = "select[id*=\'standard_sogecommerce_advanced_options_card_info_mode\']";
                    ...
                    function initFieldsAndObserver() {
                        ...
                        if (cardInfo >= 5) {
                            $$("span#sogecommerce_integrated_mode_desc")[0].show();
                            $$("table[id*=\'sogecommerce_payment_options_other_payment_means\'")[0].children[0].children[0].children[8].show();
                        } else {
                            $$("table[id*=\'sogecommerce_payment_options_other_payment_means\'")[0].children[0].children[0].children[8].hide();
                            $$("span#sogecommerce_integrated_mode_desc")[0].hide();
                        }
