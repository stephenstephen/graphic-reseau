 ...
 */
class ShipOptions extends \Lyranetwork\Sogecommerce\Block\Adminhtml\System\Config\Form\Field\FieldArray\ConfigFieldArray
{
    /**
        ...
        $script .= "\n" . '
            <script>
                 require([
                    ...
                    $$("select.sogecommerce_list_delay").each(function(elt) {
                    ...
                    $$("select.sogecommerce_list_speed").invoke("observe", "change", function() {
