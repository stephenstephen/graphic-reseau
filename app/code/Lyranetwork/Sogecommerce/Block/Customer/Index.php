 ...
 */
namespace Lyranetwork\Sogecommerce\Block\Customer;
...
class Index extends \Magento\Framework\View\Element\Template
{
    ...
    public function getStoredPaymentMeans()
    {
        ...
        $aliasIds = [
            'sogecommerce_identifier' => 'sogecommerce_masked_pan',
            'sogecommerce_sepa_identifier' => 'sogecommerce_sepa_iban_bic'
        ];
