 ...
 */
namespace Lyranetwork\Sogecommerce\Block\Payment\Iframe;
...
class Response extends \Magento\Framework\View\Element\Template
{
     ...
     * @param string $path
     * @param string $params
     * @return \Lyranetwork\Sogecommerce\Block\Payment\Iframe\Response
     */
    ...
    public function getLoaderHtml()
    {
        $block = $this->getLayout()
            ...
            ->setTemplate('Lyranetwork_Sogecommerce::payment/iframe/loader.phtml');
