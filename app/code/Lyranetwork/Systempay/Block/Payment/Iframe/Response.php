 ...
 */
namespace Lyranetwork\Systempay\Block\Payment\Iframe;
...
class Response extends \Magento\Framework\View\Element\Template
{
     ...
     * @param string $path
     * @param string $params
     * @return \Lyranetwork\Systempay\Block\Payment\Iframe\Response
     */
    ...
    public function getLoaderHtml()
    {
        $block = $this->getLayout()
            ...
            ->setTemplate('Lyranetwork_Systempay::payment/iframe/loader.phtml');
