 ...
 */
namespace Lyranetwork\Systempay\Block\Payment\Rest;
...
class Head extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        ...
        $this->method = $this->dataHelper->getMethodInstance(\Lyranetwork\Systempay\Helper\Data::METHOD_STANDARD);
    ...
    {
        return $this->_urlBuilder->getUrl('systempay/payment_rest/response', [
            '_secure' => true
        ]);
    }
