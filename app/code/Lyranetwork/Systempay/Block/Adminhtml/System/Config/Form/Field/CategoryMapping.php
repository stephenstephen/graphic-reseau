 ...
 */
class CategoryMapping extends \Lyranetwork\Systempay\Block\Adminhtml\System\Config\Form\Field\FieldArray\ConfigFieldArray
{
    /**
     * @var \Lyranetwork\Systempay\Model\System\Config\Source\CategoryFactory
     */
    protected $systempayCategoryFactory;
     ...
     * @param \Lyranetwork\Systempay\Model\System\Config\Source\CategoryFactory $systempayCategoryFactory
     * @param \Magento\Catalog\Model\CategoryFactory $categoryFactory
     * @param array $data
     */
    public function __construct(
        \Magento\Backend\Block\Template\Context $context,
        \Lyranetwork\Systempay\Model\System\Config\Source\CategoryFactory $systempayCategoryFactory,
        \Magento\Catalog\Model\CategoryFactory $categoryFactory,
        array $data = []
    ) {
        $this->systempayCategoryFactory = $systempayCategoryFactory;
    ...
    public function _prepareToRender()
    {
        ...
        $options = [];
        foreach ($this->systempayCategoryFactory->create()->toOptionArray(true) as $option) {
        ...
        $this->addColumn(
            'systempay_category',
            [
                'label' => __('Systempay category'),
                'style' => 'width: 200px;',
                'renderer' => $this->getListRenderer('_systempayCategory', $options)
            ]
        );
