...
class CheckProcessor
{
    ...
    public function prepareResponse($params)
    {
        ...
        if (! $response->isAuthentified()) {
            ...
            $this->dataHelper->log(
                "{$this->dataHelper->getIpAddress()} tries to access systempay/payment/check page without valid signature with parameters: " . json_encode($params),
