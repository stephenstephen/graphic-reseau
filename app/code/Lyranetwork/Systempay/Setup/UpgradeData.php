    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '2.4.0', '<')) {
            ...
            $customerSetup->addAttribute(
                Customer::ENTITY,
                'systempay_masked_pan',
                [
                    'type' => 'varchar',
                    'input' => 'text',
                    'label' => 'Systempay masked PAN',
            ...
            $select = $connection->select()
                ...
                ->where('status = ?', 'systempay_pending_transfer');
            ...
            if ($count == 0) {
                $connection->insert(
                    ...
                    [
                        'status' => 'systempay_pending_transfer',
        ...
        if (version_compare($context->getVersion(), '2.4.1', '<')) {
            ...
            $customerSetup->addAttribute(
                Customer::ENTITY,
                'systempay_sepa_identifier',
                [
                    'type' => 'varchar',
                    'input' => 'text',
                    'label' => 'Systempay SEPA identifier',
            ...
            $customerSetup->addAttribute(
                Customer::ENTITY,
                'systempay_sepa_iban_bic',
                [
                    'type' => 'varchar',
                    'input' => 'text',
                    'label' => 'Systempay SEPA IBAN/BIC',
