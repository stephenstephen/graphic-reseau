...
{
    protected $_code = \Lyranetwork\Systempay\Helper\Data::METHOD_SEPA;
    protected $_formBlockType = \Lyranetwork\Systempay\Block\Payment\Form\Sepa::class;
    ...
    /**
     * @var \Lyranetwork\Systempay\Model\System\Config\Source\SepaAvailableCountry
     */
     ...
     * @param \Lyranetwork\Systempay\Model\System\Config\Source\SepaAvailableCountry $sepaCountries
    ...
    public function __construct(
        ...
        \Lyranetwork\Systempay\Model\System\Config\Source\SepaAvailableCountry $sepaCountries,
    ...
    protected function setExtraFields($order)
    {
        ...
        $this->systempayRequest->set('payment_cards', 'SDD');
        ...
        if ($this->isOneClickActive() && $order->getCustomerId()) {
            ...
            if ($customer->getCustomAttribute('systempay_sepa_identifier') && $this->customerSession->getValidSepaAlias()) {
                // Customer has an identifier.
                $this->systempayRequest->set('identifier', $customer->getCustomAttribute('systempay_sepa_identifier')->getValue());

                if (! $info->getAdditionalInformation(\Lyranetwork\Systempay\Helper\Payment::SEPA_IDENTIFIER)) {
                    // Customer choose to not use alias.
                    $this->systempayRequest->set('page_action', 'REGISTER_UPDATE_PAY');
                }
            } else {
            ...
            $this->systempayRequest->set('page_action', $this->getMandateMode());
        }
    }
    ...
    public function isOneclickAvailable()
    {
        ...
        if (! $this->getCurrentCustomer() || ! ($identifier = $this->getCurrentCustomer()->getCustomAttribute('systempay_sepa_identifier'))) {
            return false;
        }
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $info->setAdditionalInformation(
            ...
            $systempayData->getData('systempay_sepa_use_identifier')
        );
