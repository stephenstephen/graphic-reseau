...
class Fullcb extends Systempay
{
    const FULLCB_THREE_TIMES_MAX_FEES = 9;
    const FULLCB_FOUR_TIMES_MAX_FEES = 12;

    protected $_code = \Lyranetwork\Systempay\Helper\Data::METHOD_FULLCB;
    protected $_formBlockType = \Lyranetwork\Systempay\Block\Payment\Form\Fullcb::class;
    ...
    protected function setExtraFields($order)
    {
        ...
        if ($info->getCcType()) {
            ...
            $this->systempayRequest->set('payment_cards', 'FULLCB3X;FULLCB4X');
        }
    }
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $option = $systempayData->getData('systempay_fullcb_option');
        if ($option) {
            $info->setCcType($option)->setAdditionalInformation(\Lyranetwork\Systempay\Helper\Payment::FULLCB_OPTION, $option);
        }
