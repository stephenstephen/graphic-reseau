...
class StandardConfigProvider extends \Lyranetwork\Systempay\Model\SystempayConfigProvider
{
    /**
     * @var string|boolean
     */
    ...
    public function __construct(
        ...
        parent::__construct(
            ...
            $urlBuilder,
            $dataHelper,
            \Lyranetwork\Systempay\Helper\Data::METHOD_STANDARD
        );
    }
    ...
    public function getConfig()
    {
        ...
        $maskedPan = '';
        if ($customer && $customer->getCustomAttribute('systempay_masked_pan')) {
            $maskedPan = $customer->getCustomAttribute('systempay_masked_pan')->getValue();
        }
    ...
    private function getIframeLoaderUrl()
    {
        ...
        return $this->urlBuilder->getUrl('systempay/payment_iframe/loader', $params);
    }
