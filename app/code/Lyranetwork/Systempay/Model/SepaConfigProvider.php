...
class SepaConfigProvider extends \Lyranetwork\Systempay\Model\SystempayConfigProvider
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct(
            ...
            $urlBuilder,
            $dataHelper,
            \Lyranetwork\Systempay\Helper\Data::METHOD_SEPA
        );
    }
    ...
    public function getConfig()
    {
        ...
        $maskedPan = '';
        if ($customer && $customer->getCustomAttribute('systempay_sepa_iban_bic')) {
            $maskedPan = $customer->getCustomAttribute('systempay_sepa_iban_bic')->getValue();
        }
