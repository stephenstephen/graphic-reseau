...
class Image extends AbstractElement
{
    ...
    public function getElementHtml()
    {
        ...
        if ((string)$this->getValue()) {
            $html = '<div id="mpattachments-current-file"><span>' . $this->getValue() . '</span></div>';
        }
    ...
    {
        return '<input id="file-path-name" type="hidden" name="'
            . parent::getName() . '[value]" value="' . $this->getValue() . '" />';
    }
