...
class Collection extends AbstractCollection
{
    ...
    public function addWebsiteGroupMethodDateFilter(
        ...
        if (!$this->getFlag('website_group_method_date_filter')) {
            ...
            $this->addCurrencyCodeFilter($currencyCode);
     ...
     * @return $this
     */
    public function addCurrencyCodeFilter($currencyCode = null)
    {
        if (!$currencyCode) {
            return $this;
        }

        $this->getSelect()->where(RuleInterface::KEY_CURRENCY_CODE . ' = ?', $currencyCode);
