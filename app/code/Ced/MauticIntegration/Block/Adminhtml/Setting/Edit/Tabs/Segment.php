...
class Segment extends \Magento\Backend\Block\Widget implements RendererInterface
{

    /**
     * @var string
     */
    public $_template = 'Ced_MauticIntegration::setting/edit/segment.phtml';
    ...
    public function getSegment()
    {
        return $this->cedMautic->create()->addFieldToFilter(
            'entity_type',
            ['eq' => \Ced\MauticIntegration\Model\CedMautic::TYPE_SEGMENT]
        );
    }
