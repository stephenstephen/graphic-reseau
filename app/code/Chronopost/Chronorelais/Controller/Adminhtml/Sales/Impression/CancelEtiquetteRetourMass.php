...
/**
 * Class CancelRetourEtiquetteMass
 *
 * @package Chronopost\Chronorelais\Controller\Adminhtml\Sales\Impression
 */
class CancelEtiquetteRetourMass extends AbstractImpression
{
    ...
    /**
     * CancelEtiquetteRetourMass constructor.
     *
                ...
                if ($shipments->count()) {
                    foreach ($shipments as $shipment) {
                        ...
                        foreach ($labels as $label) {
                            if ($label->getReservation()) {
                                $webservbt = $this->helperWebservice->cancelEtiquette(
                                    $label->getLtNumber(),
                                    $contract
                                );
