...
use Chronopost\Chronorelais\Lib\Fpdi\PdfParser\Filter\Ascii85;
use Chronopost\Chronorelais\Lib\Fpdi\PdfParser\Filter\AsciiHex;
use Chronopost\Chronorelais\Lib\Fpdi\PdfParser\Filter\FilterException;
use Chronopost\Chronorelais\Lib\Fpdi\PdfParser\Filter\Flate;
use Chronopost\Chronorelais\Lib\Fpdi\PdfParser\Filter\Lzw;
...
use Chronopost\Chronorelais\Lib\FpdiPdfParser\PdfParser\Filter\Predictor;
                        ...
                        if ($predictor->value !== 1) {
                            if (!\class_exists(Predictor::class)) {
                                throw new PdfParserException(
                                    ...
                                    'commercial "FPDI PDF-Parser" add-on (see https://www.Chronopost\Chronorelais\Lib.com/fpdi-pdf-' .
                                    'parser).',
